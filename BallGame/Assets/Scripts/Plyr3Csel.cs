...
public class Plyr3Csel : MonoBehaviour
{
    ...
    void ControlInput()
    {
        ...
        if (Input.GetButtonDown("Fire5") && selectCharacter == true)
        {
            ready = true;
        }
        if (Input.GetAxisRaw("Horizontal2") > 0.5f)
        {
            NextCharacter();
        }
        if (Input.GetAxisRaw("Horizontal2") < -0.5f)
    ...
    void CancelSelect()
    {
        if (selectCharacter == true && Input.GetButtonDown("Fire6"))
        {
        ...
        if (ready == true && Input.GetButtonDown("Fire6"))
        {
    ...
    void PlayerReady()
    {
        if (ready == true && Input.GetButtonDown("Fire5"))
        {
            ...
            if (characterSelected == 1)
            {
                GlobalControl.Instance.red = 3;
            }
            if (characterSelected == 2)
            {
                GlobalControl.Instance.blue = 3;
            }
            if (characterSelected == 3)
            {
                GlobalControl.Instance.green = 3;
            }
            if (characterSelected == 4)
            {
                GlobalControl.Instance.yellow = 3;
            }
        }
    }
