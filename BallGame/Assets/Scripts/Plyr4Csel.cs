...
public class Plyr4Csel : MonoBehaviour
{
    ...
    void ControlInput()
    {
        ...
        if (Input.GetButtonDown("Fire7") && selectCharacter == true)
        {
            ready = true;
        }
        if (Input.GetAxisRaw("Horizontal3") > 0.5f)
        {
            NextCharacter();
        }
        if (Input.GetAxisRaw("Horizontal3") < -0.5f)
    ...
    void CancelSelect()
    {
        if (selectCharacter == true && Input.GetButtonDown("Fire8"))
        {
        ...
        if(ready == true && Input.GetButtonDown("Fire8"))
        {
    ...
    void PlayerReady()
    {
        if (selectCharacter == true && Input.GetButtonDown("Fire7"))
        {
            ...
            if (characterSelected == 1)
            {
                GlobalControl.Instance.red = 4;
            }
            if (characterSelected == 2)
            {
                GlobalControl.Instance.blue = 4;
            }
            if (characterSelected == 3)
            {
                GlobalControl.Instance.green = 4;
            }
            if (characterSelected == 4)
            {
                GlobalControl.Instance.yellow = 4;
            }
        }
    }
