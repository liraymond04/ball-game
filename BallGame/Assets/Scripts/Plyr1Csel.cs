...
public class Plyr1Csel : MonoBehaviour 
{
    ...
    void ControlInput()
    {
        ...
        if (Input.GetButtonDown("Fire1") && selectCharacter == true)
        {
            ready = true;
        }
    ...
    void CancelSelect()
    {
        if(selectCharacter == true && Input.GetButtonDown("Fire2"))
        {
        ...
        if (ready == true && Input.GetButtonDown("Fire2"))
        {
    ...
    void PlayerReady()
    {
        if (ready == true && Input.GetButtonDown("Fire1"))
        {
            ...
            if(characterSelected == 1)
            {
                GlobalControl.Instance.red = 1;
            }
            if (characterSelected == 2)
            {
                GlobalControl.Instance.blue = 1;
            }
            if (characterSelected == 3)
            {
                GlobalControl.Instance.green = 1;
            }
            if (characterSelected == 4)
            {
                GlobalControl.Instance.yellow = 1;
            }
        }
    }
